...
class DynamicFrameBroadcaster(Node):
    ...
    def __init__(self):
        ...
        self.transf.header.frame_id = 'gripper_yaw_origin'
        self.transf.child_frame_id = 'gripper_yaw'
    ...
    def arm_callback(self, msg: Twist):
        ...
        quat = euler2quat(0, 0, msg.angular.z)
    ...
    def tf_timer(self):
        ...
        self.roll += self.angular_roll * dt
        self.pitch += self.angular_pitch * dt
        self.yaw += self.angular_yaw * dt
        quat = euler2quat(0,0, self.yaw)
